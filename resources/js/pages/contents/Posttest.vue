  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div v-else id="app" class="container">
        <h2 class="mb-2" style="text-align: center">แบบทดสอบหลังเรียน</h2>
        <div class="card p-3">
...
export default {
  ...
  methods: {
    ...
    showResults() {
      ...
      axios
        .post("/api/posttest_save", formData, config)
        .then((res) => {
          axios
            .get(
              "/api/checkRedirectPage2/" +
    ...
    saveCountProgress() {
      ...
      axios
        .post("/api/redirect_save/posttest_progress", formData, config)
        .then((res) => {})
        .catch((err) => {
          this.error = "Error!!";
        });
