...
<section class="section" data-id="{{ @$user->id }}">
	<div class="section-header">
     ...
     <div class="section-body">
     	<!-- <div class="row"> -->
     		<!-- <div class="col-12"> -->
				 <form class="" id="form_result" action="{{ route('users.update', $user->id ) }}" method="post" enctype="multipart/form-data">
					 @csrf
           @method('PATCH')
     			<div class="card">
                     ...
                     <div class="col-md-6">
                       <div class="form-group">
                            ...
                            <select class="form-control" name="user_status" id="user_status">
                              ...
                              <option <?= ($user->user_status == 1) ? 'selected' : ''; ?> value="1">ใช้งาน</option>
                              <option <?= ($user->user_status == 2) ? 'selected' : ''; ?> value="2">ไม่ใช้งาน</option>
                            </select>
                        </div>
                     </div>
                     <div class="col-md-6">
                       <div class="form-group">
                            ...
                            <select class="form-control" name="user_type" id="user_type">
                              <option>เลือก</option>
                              <option <?= ($user->user_type == 1) ? 'selected' : ''; ?> value="1">เจ้าหน้าที่</option>
                              <option <?= ($user->user_type == 2) ? 'selected' : ''; ?> value="2">ผู้ใช้บริการ</option>
                              <option <?= ($user->user_type == 3) ? 'selected' : ''; ?> value="3">คุณครู</option>
                            </select>
                        </div>
                     </div>
                   </div>
