...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="card p-5">
            <form action="{{ url('/posttest/exam/add/' . $subject_id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-6 form-group">
                        ...
                        <div style=" display: flex; align-items: center;">
                            <input class="form-check-input" name="answer" type="radio" id="defaultCheck" value="1" required>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div style=" display: flex; align-items: center;">
                            <input class="form-check-input" name="answer" type="radio" id="defaultCheck" value="2" required>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div style=" display: flex; align-items: center;">
                            <input class="form-check-input" name="answer" type="radio" id="defaultCheck" value="3" required>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div style=" display: flex; align-items: center;">
                            <input class="form-check-input" name="answer" type="radio" id="defaultCheck" value="4" required>
