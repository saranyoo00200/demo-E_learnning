                ...
                <div class="card-body">
                    <div class="table-responsive table-hover">
                        <table class="table table-striped" id="sortable-table">
                            ...
                            <th style="width: 15%" scope="col">หัวข้อ</th>
                            ...
                            foreach ($news as $key => $value) : ?>
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td><img src="{{ asset('image/news/' . $value->news_photo) }}" width="80px" height="80px"
                                    ...
                                    <td>
                                        <form class="delete-news-form_{{ $value->news_id }}"
                                            action="{{ route('newsManage.destroy', $value->news_id) }}" method="post">
                                            <a href="{{ route('newsManage.show', $value->news_id) }}" class="btn btn-info">
                                                <i class="fas fa-eye"></i></a>
                                            <a href="{{ route('newsManage.edit', $value->news_id) }}"
                                                class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                            <button class="btn btn-danger remove_news" data-id="{{ $value->news_id }}"
