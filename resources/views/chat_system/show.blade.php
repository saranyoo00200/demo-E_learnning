                                    ...
                                    <ul class="list-unstyled list-unstyled-border">
                                        <li class="media">
                                            <img alt="image" class="mr-3 rounded-circle" width="50"
                                                src="{{ asset('assets/backend/img/avatar/avatar-1.png') }}">
                                        ...
                                        <li class="media">
                                            <img alt="image" class="mr-3 rounded-circle" width="50"
                                                src="{{ asset('assets/backend/img/avatar/avatar-2.png') }}">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img alt="image" class="mr-3 rounded-circle" width="50"
                                                src="{{ asset('assets/backend/img/avatar/avatar-3.png') }}">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img alt="image" class="mr-3 rounded-circle" width="50"
                                                src="{{ asset('assets/backend/img/avatar/avatar-4.png') }}">
                                            <div class="media-body">
...
@section('scripts')
    <script>
        var my_image = "{{ Auth()->user()->user_photo }}";
    </script>
